...
| Featured Images in RSS (5 Star Plugins), via Freemius | 1.7.3, SDK 2.13.4 | 1, 2 | Freemius trial promotion, affiliate-program and usage-tracking opt-in notices, and the trial menu counter bubble. Licence and update notices preserved |
| Role Based Pricing for WooCommerce (Meow Crew), via Freemius | 2.0.0, SDK 2.13.2 | 1, 2 | Freemius trial promotion, its menu counter bubble and the usage-tracking opt-in, on the same rule as Featured Images in RSS. Pricing-rule validation warnings and action results preserved |
| Independent Analytics, via Freemius | 2.15.5, SDK 2.13.4 | 1 | Freemius usage-tracking opt-in ("We made a few tweaks…"). The site's own analytics dashboard widget preserved |
...
| Magical Addons for Elementor | 1.5.0 | 2 | Pro bundle sales notice (priced, returns 25 days after dismissal), and the 1.4.6 review request. Elementor-missing, Elementor/PHP version and theme-builder dependency notices preserved |

...
> **Status: stable.** Version 1.13.0. The machinery is complete, all three mechanisms
...
Version 1.13.0. Every vendor rule below was verified against that vendor's real source

...
> **Status: stable.** Version 1.4.3. The machinery is complete, all three mechanisms
...
Version 1.4.3. Every vendor rule below was verified against that vendor's real source

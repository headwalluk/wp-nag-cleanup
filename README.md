...
| Role Based Pricing for WooCommerce (Meow Crew), via Freemius | 2.0.0, SDK 2.13.2 | 1, 2 | Freemius trial promotion and its menu counter bubble, on the same rule as Featured Images in RSS. Opt-in prompt, pricing-rule validation warnings and action results preserved |

...
refutation of the rule: the vendor's gates (a bulk comment delete must have been recorded, and the check must be made on the plugin's own settings screen) are not met on those particular sites,
